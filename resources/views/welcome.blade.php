...
{{-- ============================================================ --}}
{{-- HERO SECTION (Hii ipo Dark by default, inabaki hivi hivi) --}}
{{-- ============================================================ --}}
    ...
    <div class="container mx-auto px-4 max-w-7xl relative z-20 py-32 text-center flex flex-col items-center">
        ...
        <div class="max-w-5xl space-y-10">
            ...
            <div class="flex flex-col sm:flex-row gap-5 justify-center pt-6">
                ...
                <a href="/our_work" class="inline-flex items-center justify-center border border-white/40 bg-white/5 hover:border-white hover:bg-white/10 text-white font-bold text-[12px] uppercase tracking-[0.2em] px-12 py-5 rounded-full transition duration-300 backdrop-blur-sm">
                  See Our Impact
                </a>
            </div>
        </div>
...
{{-- ============================================================ --}}
{{-- THE PROBLEM STRIP (Hii ipo na rangi ya Orange by default) --}}
{{-- ============================================================ --}}
<section class="relative py-8 shadow-xl overflow-hidden bg-gradient-to-r from-orange-600 via-orange-500 to-orange-600 z-30 border-y border-orange-400/30">
    ...
    <div class="container mx-auto px-4 max-w-7xl relative z-10">
        <div class="flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-12 text-white text-center">
            ...
            <div class="hidden sm:block w-px h-8 bg-white/20"></div>
            <a href="/our_work" class="shrink-0 bg-white/10 backdrop-blur-sm border border-white/30 text-white font-black text-[10px] uppercase tracking-widest px-6 py-3 rounded-full hover:bg-white hover:text-orange-600 transition duration-300 shadow-sm hover:shadow-lg">
               Learn More
            </a>
        </div>
    </div>
...
{{-- ============================================================ --}}
{{-- WHAT WE DO (Imeongezwa Dark Mode) --}}
{{-- ============================================================ --}}
<section class="py-28 bg-white dark:bg-slate-900 transition-colors duration-300">
    <div class="container mx-auto px-4 max-w-7xl">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            {{-- Intervention 1 --}}
            <div class="group relative bg-gradient-to-br from-sky-50 to-white dark:from-slate-800 dark:to-slate-900 border border-sky-100 dark:border-slate-700 rounded-3xl p-10 hover:shadow-2xl hover:shadow-sky-100 dark:hover:shadow-sky-900/20 transition-all duration-500 hover:-translate-y-2">
                <div class="absolute top-8 right-8 text-[80px] font-black text-sky-200 dark:text-slate-700 opacity-50 leading-none select-none">1</div>
                <div class="relative">
                    <div class="w-14 h-14 bg-sky-600 rounded-2xl flex items-center justify-center mb-8 shadow-lg shadow-sky-200 dark:shadow-none">
                    ...
                    <h3 class="text-xl font-black text-slate-800 dark:text-white uppercase tracking-normal mb-4">Early Engagement</h3>
                    <p class="text-slate-500 dark:text-slate-400 leading-relaxed mb-6">Reach her before risk begins. Connect women to care in the first trimester before anaemia becomes invisible and dangerous.</p>
                    <ul class="space-y-3 text-[11px] font-black uppercase tracking-widest text-sky-600 dark:text-sky-400">
            ...
            {{-- Intervention 2 --}}
            <div class="group relative bg-gradient-to-br from-orange-50 to-white dark:from-slate-800 dark:to-slate-900 border border-orange-100 dark:border-slate-700 rounded-3xl p-10 hover:shadow-2xl hover:shadow-orange-100 dark:hover:shadow-orange-900/20 transition-all duration-500 hover:-translate-y-2">
                <div class="absolute top-8 right-8 text-[80px] font-black text-orange-200 dark:text-slate-700 opacity-50 leading-none select-none">2</div>
                <div class="relative">
                    <div class="w-14 h-14 bg-orange-500 rounded-2xl flex items-center justify-center mb-8 shadow-lg shadow-orange-200 dark:shadow-none">
                    ...
                    <h3 class="text-xl font-black text-slate-800 dark:text-white uppercase tracking-normal mb-4">Continuous Care</h3>
                    <p class="text-slate-500 dark:text-slate-400 leading-relaxed mb-6">Build resilience through pregnancy. Anaemia evolves so care must be consistent, structured, and guided across all trimesters.</p>
                    <ul class="space-y-3 text-[11px] font-black uppercase tracking-widest text-orange-600 dark:text-orange-400">
            ...
            {{-- Intervention 3 --}}
            <div class="group relative bg-gradient-to-br from-sky-50 to-white dark:from-slate-800 dark:to-slate-900 border border-sky-100 dark:border-slate-700 rounded-3xl p-10 hover:shadow-2xl hover:shadow-sky-100 dark:hover:shadow-sky-900/20 transition-all duration-500 hover:-translate-y-2">
                <div class="absolute top-8 right-8 text-[80px] font-black text-sky-200 dark:text-slate-700 opacity-50 leading-none select-none">3</div>
                <div class="relative">
                    <div class="w-14 h-14 bg-sky-700 rounded-2xl flex items-center justify-center mb-8 shadow-lg shadow-sky-200 dark:shadow-none">
                    ...
                    <h3 class="text-xl font-black text-slate-800 dark:text-white uppercase tracking-normal mb-4">Postnatal Recovery</h3>
                    <p class="text-slate-500 dark:text-slate-400 leading-relaxed mb-6">Protect the mother after survival. Delivery is not the endpoint recovery is where the cycle is either broken or reinforced.</p>
                    <ul class="space-y-3 text-[11px] font-black uppercase tracking-widest text-sky-600 dark:text-sky-400">
        ...
        <div class="mt-14 text-center">
            <p class="text-[11px] font-black uppercase tracking-[0.3em] text-slate-400 dark:text-slate-300 bg-slate-50 dark:bg-slate-800 border border-slate-100 dark:border-slate-700 rounded-full py-4 px-8 inline-block shadow-sm transition-colors duration-300">
                Early Engagement <span class="mx-2 text-slate-300 dark:text-slate-500">→</span> Continuous Care <span class="mx-2 text-slate-300 dark:text-slate-500">→</span> Postnatal Recovery <span class="mx-2 text-slate-300 dark:text-slate-500">=</span> <span class="text-sky-600 dark:text-sky-400">A Closed Loop System</span>
            </p>
        </div>
    </div>
</section>
...
{{-- ============================================================ --}}
{{-- ABOUT US SNAPSHOT (Imeongezwa Dark Mode) --}}
{{-- ============================================================ --}}
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
            <div class="space-y-8">
                ...
                <p class="text-slate-600 dark:text-slate-400 text-lg leading-relaxed">
                    ...
                    <strong class="dark:text-slate-200">01NGO/R/3988</strong>.
                </p>
                <a href="/foundation" class="inline-flex items-center text-sky-600 dark:text-sky-400 font-black text-[12px] uppercase tracking-widest hover:text-sky-800 dark:hover:text-sky-300 transition group mt-4">
                    Full Story & Our Team
            ...
            <div class="grid grid-cols-2 gap-4">
                <div class="bg-sky-600 dark:bg-sky-700 rounded-3xl p-8 text-white space-y-3 col-span-2 shadow-sm transition-colors">
                    ...
                    <p class="text-xl font-black leading-snug tracking-normal">Mto wa Mbu, near Lake Manyara National Park</p> 
                    <p class="text-sky-100 text-sm">A strategic gateway to the Ngorongoro wildlife corridor.</p>
                </div>
                <div class="bg-white dark:bg-slate-800 border border-slate-100 dark:border-slate-700 rounded-3xl p-8 space-y-4 shadow-sm hover:shadow-md transition">
                    <div class="text-sky-500 dark:text-sky-400 w-10 h-10">
                        <svg fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="1.5">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M2.25 21h19.5m-18-18v18m10.5-18v18m6-13.5V21M6.75 6.75h.75m-.75 3h.75m-.75 3h.75m3-6h.75m-.75 3h.75m-.75 3h.75M6.75 21v-3.375c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125V21M3 3h12m-.75 4.5H21m-3.75 3.75h.008v.008h-.008v-.008zm0 3h.008v.008h-.008v-.008zm0 3h.008v.008h-.008v-.008z" />
                        </svg>
                    </div>
                    <p class="font-black text-slate-800 dark:text-white text-sm uppercase tracking-normal">Hope Memorial Dispensary</p>
                    <p class="text-slate-500 dark:text-slate-400 text-sm leading-relaxed">Frontline facility. First point of contact for pregnant women and mothers.</p>
                </div>
                <div class="bg-white dark:bg-slate-800 border border-slate-100 dark:border-slate-700 rounded-3xl p-8 space-y-4 shadow-sm hover:shadow-md transition">
                    <div class="text-orange-500 dark:text-orange-400 w-10 h-10">
                        <svg fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="1.5">
                    ...
                    <p class="font-black text-slate-800 dark:text-white text-sm uppercase tracking-normal">Reg. No. 01NGO/R/3988</p>
                    <p class="text-slate-500 dark:text-slate-400 text-sm leading-relaxed">Registered under Tanzania NGO Act, 2002 on 26 Feb 2026.</p>
                </div>
            </div>
        </div>
    </div>
...
<section class="py-28 bg-white dark:bg-slate-900 transition-colors duration-300">
    <div class="container mx-auto px-4 max-w-7xl">
        <div class="text-center mb-16">
            ...
            <h2 class="text-4xl sm:text-5xl font-black text-slate-800 dark:text-white tracking-normal leading-snug">Core Focus Areas</h2>
        </div>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div class="flex items-start space-x-5 bg-white dark:bg-slate-800 shadow-sm hover:shadow-md border border-slate-100 dark:border-slate-700 hover:border-{{ $area['color'] }}-200 dark:hover:border-{{ $area['color'] }}-500 rounded-3xl p-7 transition-all duration-300 group">
                <div class="text-{{ $area['color'] }}-500 mt-1 shrink-0 w-8 h-8">
                    <svg fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="1.5">
                        {!! $area['icon'] !!}
                    </svg>
                </div>
                <p class="font-bold text-slate-700 dark:text-slate-300 text-sm leading-relaxed group-hover:text-slate-900 dark:group-hover:text-white transition mt-1">{{ $area['title'] }}</p>
            </div>
            @endforeach
...
{{-- ============================================================ --}}
{{-- LEADERSHIP TEASER (Hii ipo Dark by default) --}}
{{-- ============================================================ --}}
    ...
    <div class="container mx-auto px-4 max-w-7xl text-center relative z-10">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-8 max-w-4xl mx-auto mb-16">
            <div class="bg-white/5 backdrop-blur-sm border border-white/10 hover:bg-white/10 transition-colors rounded-3xl p-8 text-left space-y-4 shadow-xl">
                ...
                <div>
                    <h3 class="font-black text-xl tracking-normal">Dr. Theresia Dawasa</h3>
...
{{-- ============================================================ --}}
{{-- CALL TO ACTION BANNER (Hii ipo Dark by default) --}}
{{-- ============================================================ --}}
...
{{-- ============================================================ --}}
{{-- STRATEGIC PARTNERSHIPS SECTION (Imeongezwa Dark Mode) --}}
{{-- ============================================================ --}}
<section class="py-20 bg-slate-50 dark:bg-slate-950 border-t border-b border-slate-100 dark:border-slate-800 relative overflow-hidden transition-colors duration-300">
    ...
    <div class="container mx-auto px-4 max-w-7xl text-center relative z-10">
        ...
        <div class="inline-flex items-center justify-center space-x-3 mb-12">
            <div class="h-[1px] w-12 bg-sky-200 dark:bg-slate-700"></div>
            <p class="text-[11px] font-black uppercase tracking-[0.3em] text-slate-500 dark:text-slate-400">In Strategic Partnership With</p>
            <div class="h-[1px] w-12 bg-sky-200 dark:bg-slate-700"></div>
        </div>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-3 gap-6 md:gap-10 max-w-4xl mx-auto">
            ...
            <a href="https://www.moh.go.tz/" target="_blank" rel="noopener noreferrer" class="flex flex-col items-center justify-center bg-white dark:bg-slate-800 px-6 py-8 rounded-2xl border border-slate-200 dark:border-slate-700 shadow-sm hover:shadow-md hover:border-sky-300 dark:hover:border-sky-500 transition-all duration-300">
                <img src="{{ asset('images/logo-afya.png') }}" alt="Ministry of Health Tanzania" class="h-20 w-auto object-contain mb-4">
                <span class="text-slate-800 dark:text-slate-300 text-[10px] font-black uppercase tracking-widest text-center">Ministry of Health</span>
            </a>

            {{-- 2. PO-RALG (TAMISEMI) --}}
            <a href="https://www.tamisemi.go.tz/" target="_blank" rel="noopener noreferrer" class="flex flex-col items-center justify-center bg-white dark:bg-slate-800 px-6 py-8 rounded-2xl border border-slate-200 dark:border-slate-700 shadow-sm hover:shadow-md hover:border-sky-300 dark:hover:border-sky-500 transition-all duration-300">
                <img src="{{ asset('images/logo-tamisemi.png') }}" alt="PO-RALG (TAMISEMI)" class="h-20 w-auto object-contain mb-4">
                <span class="text-slate-800 dark:text-slate-300 text-[10px] font-black uppercase tracking-widest text-center">PO-RALG (TAMISEMI)</span>
            </a>

            {{-- 3. Ministry of Community Development --}}
            <a href="https://www.jamii.go.tz/" target="_blank" rel="noopener noreferrer" class="flex flex-col items-center justify-center bg-white dark:bg-slate-800 px-6 py-8 rounded-2xl border border-slate-200 dark:border-slate-700 shadow-sm hover:shadow-md hover:border-sky-300 dark:hover:border-sky-500 transition-all duration-300">
                <img src="{{ asset('images/logo-jamii.png') }}" alt="Ministry of Community Development" class="h-20 w-auto object-contain mb-4">
                <span class="text-slate-800 dark:text-slate-300 text-[10px] font-black uppercase tracking-widest text-center">Community Development</span>
            </a>
...
{{-- ============================================================ --}}
{{-- PWA NON-INTRUSIVE INSTALL PROMPT (Imeongezwa Dark Mode) --}}
{{-- ============================================================ --}}
<div x-data="{ 
        show: false, 
        deferredPrompt: null 
    ...
    <div class="flex flex-col">
        ...
        <div class="flex gap-3">
            <button @click="show = false; sessionStorage.setItem('hope_pwa_dismissed', 'true')" 
                    class="flex-1 px-4 py-2.5 text-[11px] font-black uppercase tracking-widest text-slate-500 dark:text-slate-400 hover:text-sky-700 dark:hover:text-sky-400 bg-slate-50 dark:bg-slate-800 hover:bg-slate-100 dark:hover:bg-slate-700 rounded-lg transition">
                Not Now
            </button>
